...
func (in *PodMigrationJobStatus) DeepCopyInto(out *PodMigrationJobStatus) {
	*out = *in
	...
	if in.EvictingStartTime != nil {
		in, out := &in.EvictingStartTime, &out.EvictingStartTime
		*out = (*in).DeepCopy()
	}
...
func (in *PodMigrationSpec) DeepCopyInto(out *PodMigrationSpec) {
	*out = *in
	...
	if in.ExcludedPodSelectors != nil {
		in, out := &in.ExcludedPodSelectors, &out.ExcludedPodSelectors
